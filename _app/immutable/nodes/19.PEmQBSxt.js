...
4. Une API javascript
    Votre mod&egrave;le 3D est une recette écrite dans un fichier javacript
		</pre>`),x=e(`<img style="width: 28em;" alt="Parametrix described in condensed"/> <p style="text-align:center; margin: 0.5rem">Parametrix en condens&eacute;</p>`,1),S=e(`<pre>
...
Passage en revue de l'interface graphique
		</pre>`),C=e(`<img style="width: 28em;" alt="designer and maker"/>`),w=e(`<center><img style="width: 14em;" alt="3D shape subsets"/></center> <pre>
L'API de Geometrix pour designer des formes 3D
		</pre>`,1),T=e(`<pre>
L'API de Geometrix en bref
		</pre>`),E=e(`<p><span style="font-size:2em">Example de code</span> <img style="height: 7em; vertical-align: middle" alt="codeExample1_contour.svg"/></p> <pre style="font-size:0.8em; padding-right: 5em">
...
- dropdown (i.e. enum)
		</pre>`),O=e(`<center><img style="width: 9em;" alt="stroke and arcs"/></center> <pre>
Les contours sont composées exclusivement de:
- segments de droite
- arcs de cercle

Idéal pour générer le G-code
		</pre>`,1),k=e(`<center><img style="width: 22em;" alt="absolute relative cartesian polar"/></center> <pre>
Options possibles pour définir le prochain point
                   dans la définition d'un contour:
- Cartésien ou Polair
- Relative ou Absolue
		</pre>`,1),A=e(`<center><img style="width: 22em;" alt="three ways for defining arcs"/></center> <pre>
...
- l'angle de la tangente au début ou à la fin de l'arc
		</pre>`,1),j=e(`<center><img style="width: 22em;" alt="curve approximation"/></center> <pre>
