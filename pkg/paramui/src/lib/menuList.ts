...
const menuList: tMenuList = [
	{
		category: '',
		pages: [
			{ path: 'index', page: null, svg: 'page_index.svg'}
		]
	},
	{
		category: 'Gears',
		pages: [
			...
			{ path: 'gear/simplified_gear_wheel', page: simplifiedGearWheelDef, svg: 'page_gears.svg'}
		]
	},
	{
		category: 'Heliostat',
	...
	},
	{
		category: '',
		pages: [
			{ path: 'about', page: null, svg: 'page_about.svg'}
		]
	}
];
