...
const menuList: tMenuList = [
	...
	},
	{
		...
		pages: [
			...
			{ path: '/heliostat/ring', page: ringDef, svg: 'page_pole_rotor.svg' },
			{ path: '/heliostat/pole_holder', page: poleHolderDef, svg: 'page_pole_rotor.svg' },
			{ path: '/heliostat/ring_guidance', page: ringGuidanceDef, svg: 'page_pole_rotor.svg' },
			{ path: '/heliostat/pole_guidance', page: poleGuidanceDef, svg: 'page_pole_rotor.svg' },
	...
	},
	{
		...
		pages: [
			...
			{ path: '/docs/design_lib_list', page: null, svg: 'page_geom.svg' },
