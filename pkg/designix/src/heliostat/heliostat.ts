...
import {
	...
	heliostat_side_svg,
	heliostat_side_sizing_svg,
	heliostat_face_sizing_svg
} from './svg_heliostat';
...
const pDef: tParamDef = {
	...
	paramSvg: {
		...
		H3: heliostat_side_sizing_svg,
		H4: heliostat_side_sizing_svg,
		H5: heliostat_side_sizing_svg,
		H6: heliostat_side_sizing_svg,
		H7: heliostat_side_sizing_svg,
		H8: heliostat_side_sizing_svg,
		H9: heliostat_side_sizing_svg,
		D1: heliostat_side_sizing_svg,
		D2: heliostat_side_sizing_svg,
		D3: heliostat_side_sizing_svg,
		D4: heliostat_side_sizing_svg,
		D5: heliostat_side_sizing_svg,
		D6: heliostat_side_sizing_svg,
		D7: heliostat_side_sizing_svg,
		D8: heliostat_side_sizing_svg,
		D9: heliostat_face_sizing_svg,
		S1: heliostat_side_sizing_svg,
		S2: heliostat_side_sizing_svg,
		E1: heliostat_side_sizing_svg,
		E2: heliostat_side_sizing_svg,
		L1: heliostat_face_sizing_svg,
		L2: heliostat_side_sizing_svg,
		L3: heliostat_face_sizing_svg,
		L4: heliostat_face_sizing_svg,
		L5: heliostat_face_sizing_svg,
		L6: heliostat_face_sizing_svg,
		L7: heliostat_face_sizing_svg,
		L8: heliostat_face_sizing_svg,
		al: heliostat_side_sizing_svg,
		ar: heliostat_side_sizing_svg
	},
	sim: {
		tMax: 180,
		tStep: 0.5,
