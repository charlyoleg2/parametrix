...
const pDef: tParamDef = {
	...
	params: [
		...
		pNumber('D1', 'mm', 600, 50, 4000, 10),
		pNumber('D2', 'mm', 400, 50, 4000, 10),
		pNumber('D3', 'mm', 400, 50, 4000, 10),
		pNumber('H1', 'mm', 800, 10, 4000, 10),
		pNumber('H2', 'mm', 3000, 50, 6000, 10),
		pNumber('H3', 'mm', 400, 0, 4000, 10),
		pNumber('E1', 'mm', 20, 1, 80, 1),
		pNumber('E3', 'mm', 30, 1, 80, 1),
		pNumber('H4', 'mm', 200, 10, 1000, 10),
		pNumber('D4', 'mm', 300, 10, 1000, 10),
		pNumber('E4', 'mm', 20, 1, 80, 1),
		pNumber('H5', 'mm', 400, 10, 2000, 10),
