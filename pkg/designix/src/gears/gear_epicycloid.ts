...
function pGeom(t: number, param: tParamVal, suffix = ''): tGeom {
	...
	try {
		...
		rGeome.sub = {};
		// finalize
		rGeome.logstr += 'gear_epicycloid drawn successfully!\n';
...
const gearEpicycloidDef: tPageDef = {
	pTitle: 'Gear-epicycloid',
	pDescription: 'The epicycloid gear system',
	pDef: pDef,
	pGeom: pGeom
};

export { gearEpicycloidDef };
