...
const pDef: tParamDef = {
	...
	paramSvg: {
		module: default_param_blank_svg,
		N1: default_param_blank_svg,
		N2: default_param_blank_svg,
		angleCenterCenter: default_param_blank_svg,
		addInterAxis: default_param_blank_svg,
		c1x: default_param_blank_svg,
		c1y: default_param_blank_svg,
		ah1: default_param_blank_svg,
		dh1: default_param_blank_svg,
		bh1: default_param_blank_svg,
		bRound1: default_param_blank_svg,
		ah2: default_param_blank_svg,
		dh2: default_param_blank_svg,
		bh2: default_param_blank_svg,
		bRound2: default_param_blank_svg,
		at1: default_param_blank_svg,
		at2: default_param_blank_svg,
		involSym: default_param_blank_svg,
		involROpt: default_param_blank_svg,
		involLOpt: default_param_blank_svg,
		brr1: default_param_blank_svg,
		brr2: default_param_blank_svg,
		blr1: default_param_blank_svg,
		blr2: default_param_blank_svg,
		involArcPairs1: default_param_blank_svg,
		skinThickness1: default_param_blank_svg,
		involArcPairs2: default_param_blank_svg,
		skinThickness2: default_param_blank_svg,
		initAngle1: default_param_blank_svg,
		gw2Position: default_param_blank_svg,
		centralAxis: default_param_blank_svg,
		axisRadius: default_param_blank_svg,
		ribNb: default_param_blank_svg,
		ribWidth: default_param_blank_svg,
		ribHeight: default_param_blank_svg,
		ribRound1: default_param_blank_svg,
		ribRound2: default_param_blank_svg,
		hollow: default_param_blank_svg,
		materialHeightExt: default_param_blank_svg,
		materialHeightInt: default_param_blank_svg,
		spokeNb: default_param_blank_svg,
		spokeWidth: default_param_blank_svg,
		spokeRound: default_param_blank_svg,
		wheelAxis: default_param_blank_svg,
		wheelHeight: default_param_blank_svg,
		wheelMidExtra: default_param_blank_svg,
		wheelAxisLength: default_param_blank_svg,
		wheelAxisRadius: default_param_blank_svg,
		wheelMidRadius: default_param_blank_svg,
		wheelRadiusExtra: default_param_blank_svg,
		wheelAxisExtRound: default_param_blank_svg,
		wheelAxisIntRound: default_param_blank_svg,
		wheelExtraRound: default_param_blank_svg
	},
	sim: {
		tMax: 100,
		tStep: 0.5,
